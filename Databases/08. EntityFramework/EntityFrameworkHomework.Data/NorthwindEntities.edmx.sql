...
-- --------------------------------------------------
-- Date Created: 07/15/2013 21:54:41
-- Generated from EDMX file: E:\programming\TelerikAcademy\FullTime\01. Databases\Homework\08. EntityFramework\EntityFrameworkHomework.Data\NorthwindEntities.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[Alphabetical_list_of_products]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Alphabetical_list_of_products];
GO
IF OBJECT_ID(N'[dbo].[Category_Sales_for_1997]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Category_Sales_for_1997];
GO
IF OBJECT_ID(N'[dbo].[Current_Product_Lists]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Current_Product_Lists];
GO
IF OBJECT_ID(N'[dbo].[Customer_and_Suppliers_by_Cities]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Customer_and_Suppliers_by_Cities];
GO
IF OBJECT_ID(N'[dbo].[Invoices]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Invoices];
GO
IF OBJECT_ID(N'[dbo].[Order_Details_Extendeds]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Order_Details_Extendeds];
GO
IF OBJECT_ID(N'[dbo].[Order_Subtotals]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Order_Subtotals];
GO
IF OBJECT_ID(N'[dbo].[Orders_Qries]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Orders_Qries];
GO
IF OBJECT_ID(N'[dbo].[Product_Sales_for_1997]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Product_Sales_for_1997];
GO
IF OBJECT_ID(N'[dbo].[Products_Above_Average_Prices]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Products_Above_Average_Prices];
GO
IF OBJECT_ID(N'[dbo].[Products_by_Categories]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Products_by_Categories];
GO
IF OBJECT_ID(N'[dbo].[Sales_by_Categories]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Sales_by_Categories];
GO
IF OBJECT_ID(N'[dbo].[Sales_Totals_by_Amounts]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Sales_Totals_by_Amounts];
GO
IF OBJECT_ID(N'[dbo].[Summary_of_Sales_by_Quarters]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Summary_of_Sales_by_Quarters];
GO
IF OBJECT_ID(N'[dbo].[Summary_of_Sales_by_Years]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Summary_of_Sales_by_Years];
GO
