...
namespace GeometryAPI
{
    ...
    public class Circle : Figure, IFlat, IAreaMeasurable
    {
        ...
        public Vector3D GetNormal()
        {
            Vector3D C = this.vertices[0];
            Vector3D A = C + new Vector3D(this.Radius, 0, 0);
            Vector3D B = C + new Vector3D(0, this.Radius, 0);
    ...
    public class Cylinder : Figure, IAreaMeasurable, IVolumeMeasurable
    {
        ...
        public double GetArea()
        {
            double sizeArea = 2 * Math.PI * this.Height*this.Radius;
            return 2 * this.BaseArea + sizeArea;
        }
    ...
    public class ExtendedController : FigureController
    {
        ...
        protected override void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            switch (splitCommand[0])
            {
                case "area":
                    {
                        IAreaMeasurable currentAsIAreaMeasurable = this.currentFigure as IAreaMeasurable;
                ...
                case "normal":
                    {
                        IFlat currentAsIFlat = this.currentFigure as IFlat;
                ...
                case "volume":
                    {
                        IVolumeMeasurable currentAsIVolumeMeasurable = this.currentFigure as IVolumeMeasurable;
