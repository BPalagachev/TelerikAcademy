...
module("Snake.isHeadInSnake");
test("Snake should die if it goes through it self", function () {
    var snake = new snakeGame.Snake({
        x: 150,
        y: 150
    }, 15, 0);

    // set a piece onhead position
    snake.pieces[4].position.x = 150;
    snake.pieces[4].position.y = 150;
